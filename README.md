...
go get -u github.com/RaindeerMokus/asyncapi-codegen/pkg/extensions
```
...
```golang
//go:generate go run github.com/RaindeerMokus/asyncapi-codegen/cmd/asyncapi-codegen@<version> -i ./asyncapi.yaml -p <your-package> -o ./asyncapi.gen.go
```
