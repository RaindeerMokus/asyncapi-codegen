...
import (
	...
	issue259default "github.com/RaindeerMokus/asyncapi-codegen/test/v2/issues/259/default"
	issue259forcepointers "github.com/RaindeerMokus/asyncapi-codegen/test/v2/issues/259/forcepointers"
...
"nonReqArray": ["something"]}`,
	...
	for _, tc := range cases {
		suite.T().Run(tc.name, func(t *testing.T) {
			...
			assert.NoError(t, json.Unmarshal([]byte(tc.inJSON), &out))
