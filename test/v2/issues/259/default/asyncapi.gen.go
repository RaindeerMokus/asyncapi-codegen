// Package "issue259default" provides primitives to interact with the AsyncAPI specification.
//
// Code generated by github.com/RaindeerMokus/asyncapi-codegen version (devel) DO NOT EDIT.
package issue259default
...
type TestMessagePayload struct {
	NonReqArray []string `json:"nonReqArray,omitempty"`
	NonReqField *string  `json:"nonReqField,omitempty"`
	ReqArray    []string `json:"reqArray" validate:"required"`
	ReqField    string   `json:"reqField"`
}
