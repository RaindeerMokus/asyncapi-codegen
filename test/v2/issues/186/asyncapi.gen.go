...
func (c *AppController) SubscribeAll(ctx context.Context, as AppSubscriber) error {
	...
	if err := c.SubscribeV2Issue186Star(ctx, as.V2Issue186Star); err != nil {
		return err
	}
...
func (c *AppController) listenToV2Issue186AngleNextMessage(
	...
	if err := c.executeMiddlewares(msgCtx, &acknowledgeableBrokerMessage.BrokerMessage, func(middlewareCtx context.Context) error {
		// Process message
		msg, err := brokerMessageToV2Issue186AngleMessage(acknowledgeableBrokerMessage.BrokerMessage)
		if err != nil {
			return err
		}
...
func (c *AppController) listenToV2Issue186StarNextMessage(
	...
	if err := c.executeMiddlewares(msgCtx, &acknowledgeableBrokerMessage.BrokerMessage, func(middlewareCtx context.Context) error {
		// Process message
		msg, err := brokerMessageToV2Issue186StarMessage(acknowledgeableBrokerMessage.BrokerMessage)
		if err != nil {
			return err
		}
...
// brokerMessageToV2Issue186AngleMessage will fill a new V2Issue186AngleMessage with data from generic broker message
func brokerMessageToV2Issue186AngleMessage(bMsg extensions.BrokerMessage) (V2Issue186AngleMessage, error) {
	var msg V2Issue186AngleMessage
...
// toBrokerMessage will generate a generic broker message from V2Issue186AngleMessage data
func (msg V2Issue186AngleMessage) toBrokerMessage() (extensions.BrokerMessage, error) {
...
// brokerMessageToV2Issue186StarMessage will fill a new V2Issue186StarMessage with data from generic broker message
func brokerMessageToV2Issue186StarMessage(bMsg extensions.BrokerMessage) (V2Issue186StarMessage, error) {
	var msg V2Issue186StarMessage
...
// toBrokerMessage will generate a generic broker message from V2Issue186StarMessage data
func (msg V2Issue186StarMessage) toBrokerMessage() (extensions.BrokerMessage, error) {
	// TODO: implement checks on message
...
const (
	// V2Issue186AnglePath is the constant representing the 'V2Issue186Angle' channel path.
	V2Issue186AnglePath = "v2.issue186.angle.>"
	// V2Issue186StarPath is the constant representing the 'V2Issue186Star' channel path.
	V2Issue186StarPath = "v2.issue186.star.*.*"
)
