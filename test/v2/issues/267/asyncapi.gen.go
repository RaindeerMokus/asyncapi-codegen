// Package "issue267" provides primitives to interact with the AsyncAPI specification.
//
...
// PublishV2Issue267Test will publish messages to 'v2.issue267.test' channel
func (c *AppController) PublishV2Issue267Test(
	ctx context.Context,
	msg V2Issue267TestMessage,
) error {
	// Get channel path
	path := "v2.issue267.test"
...
type UserSubscriber interface {
	// V2Issue267Test subscribes to messages placed on the 'v2.issue267.test' channel
	V2Issue267Test(ctx context.Context, msg V2Issue267TestMessage) error
}
...
func (c *UserController) SubscribeAll(ctx context.Context, as UserSubscriber) error {
	...
	if err := c.SubscribeV2Issue267Test(ctx, as.V2Issue267Test); err != nil {
		return err
	}
...
func (c *UserController) UnsubscribeAll(ctx context.Context) {
	c.UnsubscribeV2Issue267Test(ctx)
}

// SubscribeV2Issue267Test will subscribe to new messages from 'v2.issue267.test' channel.
//
// Callback function 'fn' will be called each time a new message is received.
func (c *UserController) SubscribeV2Issue267Test(
	ctx context.Context,
	fn func(ctx context.Context, msg V2Issue267TestMessage) error,
) error {
	// Get channel path
	path := "v2.issue267.test"
...
func (c *UserController) listenToV2Issue267TestNextMessage(
	path string,
	...
	if err := c.executeMiddlewares(msgCtx, &acknowledgeableBrokerMessage.BrokerMessage, func(middlewareCtx context.Context) error {
		// Process message
		msg, err := brokerMessageToV2Issue267TestMessage(acknowledgeableBrokerMessage.BrokerMessage)
		if err != nil {
			return err
		}
...
// UnsubscribeV2Issue267Test will unsubscribe messages from 'v2.issue267.test' channel.
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *UserController) UnsubscribeV2Issue267Test(ctx context.Context) {
	// Get channel path
	path := "v2.issue267.test"
...
// V2Issue267TestMessage is the message expected for 'V2Issue267TestMessage' channel.
type V2Issue267TestMessage struct {
	// Payload will be inserted in the message payload
	Payload TestSchema
}

func NewV2Issue267TestMessage() V2Issue267TestMessage {
	var msg V2Issue267TestMessage

	return msg
}

// brokerMessageToV2Issue267TestMessage will fill a new V2Issue267TestMessage with data from generic broker message
func brokerMessageToV2Issue267TestMessage(bMsg extensions.BrokerMessage) (V2Issue267TestMessage, error) {
	var msg V2Issue267TestMessage
...
// toBrokerMessage will generate a generic broker message from V2Issue267TestMessage data
func (msg V2Issue267TestMessage) toBrokerMessage() (extensions.BrokerMessage, error) {
...
const (
	// V2Issue267TestPath is the constant representing the 'V2Issue267Test' channel path.
	V2Issue267TestPath = "v2.issue267.test"
)
